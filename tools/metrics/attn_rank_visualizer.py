...
device = 'cpu'
CHECKPOINT_PATH = "/Users/jonathanmiddleton/models/checkpoints/350m-instruct/20251013T1953-val1.650-step000700-run1-best.pt"
LAYER_ID = 4
...
attn: CausalSelfAttention = model.blocks[LAYER_ID].attn
...
with torch.no_grad():
    ...
    #
    #
    # A2 = attention_matrix_from_attn2(attn, X)
    # ranks, masses, max_rank = per_head_metrics(A2)
    # print('Per‑head effective ranks:', ranks)
    # print('Per‑head columns@90%:', masses)
    # print('MaxRank(layer) =', max_rank)
    # show_attention_heatmap(A2, head=0, title='Attention matrix2 — head 0')
    # plot_head_ranks(ranks)
    # plot_head_masses(masses)
#
